#Coding Class Cooks
This is git repository we use to learn about git creating recipes 

## jollof rice recipes 
### About the recipes 
This is a popural a African delicacy made with rice
### List OF INGNREDIENTS
1. Rice 
2. 6 large tomatoes.
3. large onions.
...
### The cooking 
### WHAT IT looks like
[!Party jollof rice plaintian and fish] (A wouderful famliy meal)
love to try
### WHAT YOU CAN ADD
Red pepper base: Make a flavorful base with tomatoes, red bell pepper, red onion, ginger, habenero pepper, and garlic. Seasonings: Season the rice with bay leaves, fresh thyme, curry powder, and white pepper. Broth: You can use either beef, chicken, or vegetable broth.